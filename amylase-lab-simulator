...
<head>
    ...
    <style>
        ...
        .instructions { background: #fff3cd; border-left: 5px solid #ffc107; padding: 15px; margin-bottom: 20px; font-weight: bold; font-size: 1.1em; color: #856404; line-height: 1.4;}
...
<div class="container">
    ...
    <div id="setup-panel" class="panel active-panel">
        ...
        <div class="setup-controls">
            ...
            <div id="green-light">✅ ALL CORRECT! GREEN LIGHT GRANTED. Proceeding to Guided Experiment...</div>
    ...
    <div id="experiment-panel" class="panel">
        ...
        <h2>Part 2: Conducting the Experiment</h2>
        ...
        <div class="controls">
            ...
            <button id="btn-test" onclick="takeSample()" disabled>5. Test Mixture (Add a drop of mixture at 1-minute intervals)</button>
...
<script>
    ...
    // Phase 1 Logic: Setup Validation with Detailed Feedback
    ...
    function verifySetup() {
        ...
        if (!document.getElementById('t4-starch').checked || document.getElementById('t4-amylase').checked || document.getElementById('t4-ph2').checked || document.getElementById('t4-ph7').checked || document.getElementById('t4-ph9').checked || !document.getElementById('t4-water').checked) {
            ...
            errors.push("❌ Control Tube is incorrect. To prove starch doesn't break down alone, you need exactly: Starch and Distilled Water. (No Amylase!)");
        ...
        document.getElementById('tube-selector').addEventListener('change', function() {
            ...
            if(this.value !== "none") {
                ...
                if(this.value === 'control') {
                    ...
                    updateInstruction(`Step 3: You selected the Control Tube. Click the Incubate button to simulate waiting 5 minutes for the water to reach room temperature before adding starch.`);

                } else {

                    updateInstruction(`Step 3: You selected a pH tube. Click 'Incubate' to mix the Amylase with the pH buffer and wait 5 minutes. This lets the enzyme adjust to the pH before adding starch.`);
    ...
    function incubate() {
        ...
        // Quick visual simulation of time passing
        ...
        let interval = setInterval(() => {
            ...
            if(waitTime >= 5) {
                ...
                updateInstruction("Step 4: Incubation complete! Now, click 'Add Starch & Start' to begin the reaction.");
    ...
    function addStarchAndStart() {
        ...
        updateInstruction("Step 5: Starch added! The reaction has started. Time 0: Test your first drop immediately by clicking the 'Test Mixture' button.");

        

        takeSample(); // Auto test minute 0
    ...
    function takeSample() {
        ...
        if (wellsUsedCount < maxWells) {
            ...
            updateInstruction(`Minute ${timerMinutes - 1} recorded. Click 'Test Mixture' to advance time 1 minute and test the next drop.`);
